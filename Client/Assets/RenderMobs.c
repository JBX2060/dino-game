                          ...
                          uint8_t flags)
{
    ...
    */
    ...
    case rr_mob_id_portal_hell_creek:
        ...
        render_sprite(renderer, id, 0, flags);
        break;
    case rr_mob_id_portal_centralia:
        rr_renderer_scale(renderer, 0.4f);
        render_sprite(renderer, id, 0, flags);
        break;  
...
void rr_renderer_mob_cache_init()
{
    ...
    rr_renderer_spritesheet_init(&mob_sprites[20], NULL, 384, 384,
                                 rr_beehive_draw, 0);

    rr_renderer_spritesheet_init(&mob_sprites[21], NULL, 384, 384,
                                 rr_beehive_draw, 0);

    rr_renderer_spritesheet_init(&mob_sprites[22], NULL, 384, 384,
                                 rr_beehive_draw, 0);
}
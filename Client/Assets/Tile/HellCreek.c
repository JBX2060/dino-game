...
void rr_hc_tile_2_draw(struct rr_renderer *renderer)
{
    ...
    rr_renderer_bezier_curve_to(renderer, 60.02, 60.04, 66.12, 45.17, 79.06,
                                39.78);
    rr_renderer_bezier_curve_to(renderer, 85.27, 37.19, 92.25, 37.18, 98.48,
                                39.74);
    rr_renderer_bezier_curve_to(renderer, 104.71, 42.31, 109.66, 47.24, 112.25,
                                53.46);
    rr_renderer_bezier_curve_to(renderer, 117.66, 66.41, 111.55, 81.28, 98.62,
                                86.68);
    rr_renderer_bezier_curve_to(renderer, 85.68, 92.07, 70.82, 85.94, 65.42,
                                72.99);
    rr_renderer_fill(renderer);
    rr_renderer_set_fill(renderer, 0xff371d08);
    rr_renderer_begin_path(renderer);
    rr_renderer_move_to(renderer, 20.35, -7.27);
    rr_renderer_bezier_curve_to(renderer, 14.14, -22.15, 21.16, -39.23, 36.02,
                                -45.43);
    rr_renderer_bezier_curve_to(renderer, 43.16, -48.40, 51.19, -48.41, 58.34,
                                -45.46);
    rr_renderer_bezier_curve_to(renderer, 65.50, -42.51, 71.19, -36.84, 74.18,
                                -29.69);
    rr_renderer_bezier_curve_to(renderer, 80.39, -14.81, 73.37, 2.27, 58.51,
                                8.46);
    rr_renderer_bezier_curve_to(renderer, 43.64, 14.66, 26.56, 7.61, 20.35,
                                -7.27);
    rr_renderer_fill(renderer);
    rr_renderer_set_fill(renderer, 0xff371d08);
    rr_renderer_begin_path(renderer);
    rr_renderer_move_to(renderer, -32.99, -84.31);
    rr_renderer_bezier_curve_to(renderer, -39.20, -99.19, -32.18, -116.28,
                                -17.32, -122.47);
    rr_renderer_bezier_curve_to(renderer, -10.18, -125.44, -2.15, -125.46, 5.00,
                                -122.51);
    rr_renderer_bezier_curve_to(renderer, 12.16, -119.56, 17.85, -113.88, 20.84,
                                -106.74);
    rr_renderer_bezier_curve_to(renderer, 27.05, -91.86, 20.03, -74.77, 5.17,
                                -68.58);
    rr_renderer_bezier_curve_to(renderer, -9.70, -62.39, -26.78, -69.43, -32.99,
                                -84.31);
    rr_renderer_fill(renderer);
    rr_renderer_set_fill(renderer, 0xff371d08);
    rr_renderer_begin_path(renderer);
    rr_renderer_move_to(renderer, -103.07, 11.59);
    rr_renderer_bezier_curve_to(renderer, -109.28, -3.30, -102.26, -20.38,
                                -87.40, -26.57);
    rr_renderer_bezier_curve_to(renderer, -80.26, -29.55, -72.23, -29.56,
                                -65.07, -26.61);
    rr_renderer_bezier_curve_to(renderer, -57.92, -23.66, -52.22, -17.99,
                                -49.24, -10.84);
    rr_renderer_bezier_curve_to(renderer, -43.03, 4.04, -50.04, 21.12, -64.91,
                                27.32);
    rr_renderer_bezier_curve_to(renderer, -79.77, 33.51, -96.86, 26.47, -103.07,
                                11.59);
    rr_renderer_fill(renderer);
    rr_renderer_set_fill(renderer, 0xff371d08);
    rr_renderer_begin_path(renderer);
    ...
    rr_renderer_bezier_curve_to(renderer, 42.06, -54.73, 46.71, -66.04, 56.55,
                                -70.14);
    rr_renderer_bezier_curve_to(renderer, 61.28, -72.11, 66.60, -72.11, 71.34,
                                -70.16);
    rr_renderer_bezier_curve_to(renderer, 76.08, -68.20, 79.85, -64.45, 81.83,
                                -59.71);
    rr_renderer_bezier_curve_to(renderer, 85.94, -49.86, 81.30, -38.55, 71.45,
                                -34.46);
    rr_renderer_bezier_curve_to(renderer, 61.60, -30.36, 50.29, -35.03, 46.17,
                                -44.88);
    rr_renderer_fill(renderer);
    rr_renderer_set_fill(renderer, 0xff371d08);
    rr_renderer_begin_path(renderer);
    rr_renderer_move_to(renderer, -32.36, -50.56);
    rr_renderer_bezier_curve_to(renderer, -36.47, -60.42, -31.83, -71.72,
                                -21.98, -75.82);
    rr_renderer_bezier_curve_to(renderer, -17.25, -77.79, -11.93, -77.79, -7.19,
                                -75.84);
    rr_renderer_bezier_curve_to(renderer, -2.45, -73.88, 1.32, -70.13, 3.29,
                                -65.40);
    rr_renderer_bezier_curve_to(renderer, 7.41, -55.54, 2.76, -44.23, -7.08,
                                -40.14);
    rr_renderer_bezier_curve_to(renderer, -16.93, -36.04, -28.25, -40.71,
                                -32.36, -50.56);
    rr_renderer_fill(renderer);
    rr_renderer_set_fill(renderer, 0xff371d08);
    rr_renderer_begin_path(renderer);
    rr_renderer_move_to(renderer, -93.98, -83.97);
    rr_renderer_bezier_curve_to(renderer, -98.09, -93.82, -93.45, -105.13,
                                -83.60, -109.23);
    rr_renderer_bezier_curve_to(renderer, -78.87, -111.20, -73.55, -111.20,
                                -68.81, -109.25);
    rr_renderer_bezier_curve_to(renderer, -64.07, -107.29, -60.30, -103.54,
                                -58.32, -98.80);
    rr_renderer_bezier_curve_to(renderer, -54.21, -88.95, -58.86, -77.64,
                                -68.70, -73.54);
    rr_renderer_bezier_curve_to(renderer, -78.55, -69.45, -89.86, -74.11,
                                -93.98, -83.97);
    rr_renderer_fill(renderer);
    rr_renderer_set_fill(renderer, 0xff371d08);
    rr_renderer_begin_path(renderer);
    rr_renderer_move_to(renderer, -104.27, -24.04);
    rr_renderer_bezier_curve_to(renderer, -107.01, -30.60, -103.92, -38.13,
                                -97.37, -40.86);
    rr_renderer_bezier_curve_to(renderer, -94.23, -42.17, -90.69, -42.18,
                                -87.54, -40.88);
    rr_renderer_bezier_curve_to(renderer, -84.38, -39.58, -81.87, -37.08,
                                -80.56, -33.93);
    rr_renderer_bezier_curve_to(renderer, -77.82, -27.38, -80.90, -19.85,
                                -87.45, -17.12);
    rr_renderer_bezier_curve_to(renderer, -94.00, -14.38, -101.53, -17.49,
                                -104.27, -24.04);
    rr_renderer_fill(renderer);
    rr_renderer_set_fill(renderer, 0xff371d08);
    rr_renderer_begin_path(renderer);
    rr_renderer_move_to(renderer, 52.14, 83.20);
    rr_renderer_bezier_curve_to(renderer, 49.40, 76.65, 52.49, 69.12, 59.04,
                                66.38);
    rr_renderer_bezier_curve_to(renderer, 62.18, 65.07, 65.72, 65.07, 68.88,
                                66.37);
    rr_renderer_bezier_curve_to(renderer, 72.03, 67.67, 74.54, 70.16, 75.86,
                                73.31);
    rr_renderer_bezier_curve_to(renderer, 78.60, 79.87, 75.51, 87.40, 68.96,
                                90.13);
    rr_renderer_bezier_curve_to(renderer, 62.41, 92.86, 54.88, 89.76, 52.14,
                                83.20);
    rr_renderer_fill(renderer);
    rr_renderer_set_fill(renderer, 0xff371d08);
    rr_renderer_begin_path(renderer);
    rr_renderer_move_to(renderer, 2.86, 95.81);
    rr_renderer_bezier_curve_to(renderer, 0.12, 89.26, 3.21, 81.73, 9.75,
                                79.00);
    rr_renderer_bezier_curve_to(renderer, 12.90, 77.68, 16.44, 77.68, 19.59,
                                78.98);
    rr_renderer_bezier_curve_to(renderer, 22.75, 80.28, 25.26, 82.78, 26.57,
                                85.93);
    rr_renderer_bezier_curve_to(renderer, 29.31, 92.48, 26.23, 100.01, 19.68,
                                102.74);
    rr_renderer_bezier_curve_to(renderer, 13.13, 105.47, 5.60, 102.37, 2.86,
                                95.81);
    rr_renderer_fill(renderer);
    rr_renderer_set_fill(renderer, 0xff371d08);
    rr_renderer_begin_path(renderer);
    rr_renderer_move_to(renderer, -45.10, -41.45);
    rr_renderer_bezier_curve_to(renderer, -47.84, -48.00, -44.76, -55.53,
                                -38.21, -58.26);
    rr_renderer_bezier_curve_to(renderer, -35.06, -59.58, -31.52, -59.58,
                                -28.37, -58.28);
    rr_renderer_bezier_curve_to(renderer, -25.21, -56.98, -22.70, -54.48,
                                -21.39, -51.34);
    rr_renderer_bezier_curve_to(renderer, -18.65, -44.78, -21.74, -37.25,
                                -28.28, -34.52);
    rr_renderer_bezier_curve_to(renderer, -34.83, -31.79, -42.36, -34.89,
                                -45.10, -41.45);
    rr_renderer_fill(renderer);
    rr_renderer_set_fill(renderer, 0xff371d08);
    rr_renderer_begin_path(renderer);

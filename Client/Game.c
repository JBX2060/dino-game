                        ...
                        void *captures)
{
    ...
    rr_api_on_get_password(
        "5d68a8ec6cbf3997a641803260390362d59681bc7524ef3a3fd67afddaba0ba96d1196"
        "d30834aa25aa1440cadffb4c87af6495e613c535b793cc1c71aa8c4d04",
        this);
}
...
static uint8_t ui_not_hidden(struct rr_ui_element *this, struct rr_game *game)
{
...
/*static unit8_t bullshit(struct rr_ui_element *this,
                                struct rr_game *game)
{
    return 1;
}*/
            ...
            rr_ui_set_background(
                rr_ui_v_container_init(rr_ui_container_init(), 10, 20,
                    rr_ui_v_container_init(rr_ui_container_init(), 0, 10,
                        rr_ui_text_init("rwar.fun", 96, 0xffffffff),
                                         ...
                                         uint64_t size)
{
    ...
    case rr_websocket_event_type_close:
        ...
        if (size == 1001)
        {
            EM_ASM({
                alert(
                    'Multibox or server restart detected, please close the other tab or reload the page to continue.');
            });
        }
        break;
                          ...
                          struct rr_simulation *simulation)
{
    ...
    if (this->cache.show_hitboxes)
    {
        ...
        rr_renderer_scale(this->renderer,
                          1 / (1 + physical->deletion_animation * 0.5));
        rr_renderer_scale(this->renderer,
                          1 / RR_MOB_RARITY_SCALING[mob->rarity].radius);
...
#undef GRID_SIZE
    ...
    if (!rr_is_text_input_focused())
    {
        ...
        this->cache.show_hitboxes ^= 0;
        this->cache.hide_ui ^= 0;
    ...
    if (this->menu_open == 0)
        this->player_info->fov_adjustment =
            rr_fclamp(this->player_info->fov_adjustment -
                          this->input_data->scroll_delta * 0.001,
                      0, 1);
...
void rr_game_connect_socket(struct rr_game *this)
{
    ...
    rr_websocket_connect_to(&this->socket, "wss://rwar.fun:8443");

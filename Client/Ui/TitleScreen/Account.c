            ...
            rr_ui_v_pad(
                rr_ui_set_justify(
                    rr_ui_v_container_init(
                        ...
                        rr_ui_text_init("Account Info", 24, 0xffffffff),
                        rr_ui_static_space_init(10),
                        rr_ui_h_container_init(rr_ui_container_init(), 0, 0, 
                            rr_ui_text_init("Account ID:", 15, 0xffffffff),
                            rr_ui_text_init("Player", 15, 0xffffffff),
                        ...
                        rr_ui_choose_element_init(
                            ...
                            rr_ui_text_init("DO NOT SHARE", 20, 0xFF0000),
                            linked_account
                        ),
                        NULL
                    ), -1, -1

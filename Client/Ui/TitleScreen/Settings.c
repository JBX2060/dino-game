...
char const *regions[3] = {"Closest", "San Hose", "habibi cat basement"};
...
static uint8_t settings_container_should_show(struct rr_ui_element *this,
                                              struct rr_game *game)
{
    return game->menu_open == rr_game_menu_settings && !game->cache.hide_ui;
}
            ...
            rr_ui_v_pad(
                rr_ui_set_justify(
                    rr_ui_v_container_init(
                        ...
                        rr_ui_flex_container_init(
                            rr_ui_h_container_init(
                                ...
                                rr_ui_text_init("Mouse movement", 15,
                                                0xffffffff),
                                NULL),
                            rr_ui_text_init("[m]", 15, 0xffffffff), 10),
                        // rr_ui_flex_container_init(
                        //     rr_ui_h_container_init(
                        //         rr_ui_container_init(), 5, 10,
                        ...
                        //         0xffffffff), NULL),
                        //     rr_ui_text_init("[k]", 15, 0xffffffff), 10),
                        // rr_ui_flex_container_init(
                        //     rr_ui_h_container_init(
                        //         rr_ui_container_init(), 5, 10,
                        //         rr_ui_toggle_box_init(
                        //             &game->cache.hold_defense),
                        //         rr_ui_text_init("Hold defense", 15,
                        //         0xffffffff), NULL),
                        //     rr_ui_text_init("[l]", 15, 0xffffffff), 10),
                        rr_ui_set_justify(
                            rr_ui_h_container_init(
                                rr_ui_container_init(), 5, 10,
                                rr_ui_toggle_box_init(
                        ...
                        //         rr_ui_container_init(), 5, 10,
                        //         rr_ui_toggle_box_init(
                        //             &game->cache.show_hitboxes),
                        //         rr_ui_text_init("Show hitboxes", 15,
                        //                         0xffffffff),
                        //         NULL),
                        //     rr_ui_text_init("[h]", 15, 0xffffffff), 10),
                        rr_ui_set_justify(
                            rr_ui_h_container_init(
                                rr_ui_container_init(), 5, 10,
                                rr_ui_toggle_box_init(
                        ...
                        //     rr_ui_h_container_init(
                        //         rr_ui_container_init(), 5, 10,
                        //         rr_ui_toggle_box_init(&game->cache.hide_ui),
                        //         rr_ui_text_init("Hide UI", 15, 0xffffffff),
                        //         NULL),
                        //     rr_ui_text_init("[i]", 15, 0xffffffff), 10),
                        rr_ui_set_justify(
                            rr_ui_h_container_init(
                                rr_ui_container_init(), 5, 10,
                                rr_ui_toggle_box_init(
                                    &game->cache.disable_chat),
                                rr_ui_text_init("Disable chat", 15, 0xffffffff),
                                NULL),
                            -1, -1),
                        rr_ui_set_justify(
                            rr_ui_h_container_init(
                        ...
                        rr_ui_flex_container_init(
                            rr_ui_h_container_init(
                                ...
                                rr_ui_text_init("Debug mode", 15, 0xffffffff),
                                NULL),
                            rr_ui_text_init("[;]", 15, 0xffffffff), 10),
                        NULL),
                    -1, -1),
                50),
            0x40ffffff),
